...
extern u32 GetSecPerCls();
extern u32 GetFisrtCls();
...
extern FAT_FILE* FAT2_fopen_CreateForWrite_on_CurrentFolder_AA(const char *pFilenameAlias,const u16 *pFilenameUnicode);
...
extern bool FAT2_move(const char *pPathAliasFrom,const char *pPathAliasTo,UnicodeChar *DesPath,UnicodeChar *FileName);
extern bool FAT2_Copy( char *pFullPathAliasFrom, char *pFullPathAliasTo,const char *pPathAliasTo);//const char *pFilenameAlias);
