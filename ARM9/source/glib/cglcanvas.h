...
public:
  ...
  void TextOutUTF8_StartMid(const int x,const int y,const int wbutton,const char *str) const;
  ...
  const TglUnicode *TextOutW_WidthOther(const int x,const int y,const int widthother,const TglUnicode *str) const;
};
