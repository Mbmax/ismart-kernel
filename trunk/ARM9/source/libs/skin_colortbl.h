...
//    ShowLogHalt();
  ...
  if(strcmp(section,"EZV_SYSTEM")==0){
	  TColorTable_ZV *pct=&ColorTable.ZV_SYSTEM;
    if(strcmp(key,"SYS_Color1")==0){
      pct->SYS_Color1=colvalue;
      return;
    }
    if(strcmp(key,"SYS_Color2")==0){
      pct->SYS_Color2=colvalue;
      return;
    }
