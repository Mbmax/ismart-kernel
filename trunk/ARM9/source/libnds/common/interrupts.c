/*---------------------------------------------------------------------------------
	$Id: interrupts.c,v 1.1 2010/08/17 12:00:57 cpy Exp $
	...
	$Log: interrupts.c,v $
	Revision 1.1  2010/08/17 12:00:57  cpy
	
	Committed on the Free edition of March Hare Software CVSNT Server.
	Upgrade to CVS Suite for more features and support:
	http://march-hare.com/cvsnt/
	
	Revision 1.1  2009/03/30 16:05:01  administrator
	
	Committed on the Free edition of March Hare Software CVSNT Server.
	Upgrade to CVS Suite for more features and support:
	http://march-hare.com/cvsnt/
	
	Revision 1.1  2009/03/30 15:26:29  administrator
	最初建立的版本
	Committed on the Free edition of March Hare Software CVSNT Server.
	Upgrade to CVS Suite for more features and support:
	http://march-hare.com/cvsnt/
...
__attribute__ ((section (".dtcm"))) struct IntTable irqTable[MAX_INTERRUPTS] INT_TABLE_SECTION;
